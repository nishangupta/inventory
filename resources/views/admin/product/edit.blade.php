            ...
            <div class="card-body text-muted">
              ...
              <form action="{{route('product.update',$product)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="discount" placeholder="Discount" value="{{$product->discount??old('discount')}}" class="form-control">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="textarea form-control" name="description" placeholder="Short Description here">{{ $product->description??old('description')}}</textarea>
                </div>
