...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Quotation Filtering</h1>
        </div>
        <div class="col-sm-6">
          <a href="{{route('quotation.index')}}" class="btn btn-secondary btn-sm float-right">Go back</a>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="container-fluid">
        <form action="{{route('quotation.filter')}}" class="" method="Get">
