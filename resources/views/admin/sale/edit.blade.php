            ...
            <div class="card-body text-muted">
              ...
              <form action="{{route('sale.update',$sale)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" placeholder="Title" value="{{$sale->title??old('title')}}" class="form-control" required autofocus>
                </div>

                <div class="form-group">
                  <label for="">Units</label>
                  <input type="text" name="unit" placeholder="Unit" value="{{$sale->unit??old('unit')}}" class="form-control" >
                </div>
                ...
                <div class="form-group">
                  ...
                  <select name="product_id" class="form-control">
                    ...
                    <option value="{{$product->id}}" {{$product->id == $sale->product->id ?'selected':''}} >{{$product->title}} - {{$product->actualPrice}}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="textarea form-control" name="description" placeholder="Short Description here">{{ $sale->description??old('description')}}</textarea>
                </div>
